...
<div class="container" style="margin-top: 50px; margin-bottom: 50px;">
    <div class="card shadow-lg text-center p-5" style="max-width: 600px; margin: 0 auto;">
        ...
        <div class="input-group mb-3">
            <input type="text" class="form-control text-center" value="00020126580014br.gov.bcb.pix0136123e4567-e89b-12d3-a456-426614174000" readonly>
            <button class="btn btn-outline-secondary" type="button">Copiar</button>
        </div>

        <p class="small text-muted mt-3">
            Após o pagamento, o status mudará para "Pago" automaticamente.<br>
            (Simulação: Considere pago).
        </p>
